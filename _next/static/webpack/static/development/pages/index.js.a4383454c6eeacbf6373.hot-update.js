  ...
  function App(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "loadData", function (make, model, shouldLoadModels) {
      ...
      if (make) {
        ...
        fetch("http://localhost:/vehicles/" + uri) // fetch("https://hofpnvfyu2.execute-api.us-east-1.amazonaws.com/vehicles/" + uri)
        .then(function (res) {
          return res.json();
        }).then(function (data) {
          _this.setState({
...
//# sourceMappingURL=index.js.a4383454c6eeacbf6373.hot-update.js.map